...
def spawnNewAlien(i, j):
    ...
    newAlien = Entity(5 * (6 - j), startPosx, startPosy, imageName, 1, width, height)
...
def printEndMessage(message):
    text = game.font.render(message, 1, white)
...
player = Entity(-100, width/2, 400, "img/player.png", 3, width, height)
game = Game(0, "img/heart.png", aliens, player, width, height, size)
